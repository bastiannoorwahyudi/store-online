                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-2" data-aos="zoom-in">
                            {{-- kondisi jika user login, bisa checkout, jika tidak,akandi arahkan ke untuk login --}}
                            @auth
                ...
                <div class="row">
                    <div class="col-12 col-lg-8">
                        <ul class="list-unstyled">
                            <li class="media">
                            <img src="/images/testimonial/icon-testimonial-1.png" alt="" class="mr-3 rounded-circle">
                            ...
                            <li class="media">
                            <img src="/images/testimonial/icon-testimonial-2.png" alt="" class="mr-3 rounded-circle">
                                <div class="media-body">
                                    <h5 class="mt-2 mb-1">
                                    Anna Sukkirata
                                    </h5>
                            ...
                            <li class="media">
                            <img src="/images/testimonial/icon-testimonial-3.png" alt="" class="mr-3 rounded-circle">
                                <div class="media-body">
                                    <h5 class="mt-2 mb-1">
                                    Dakimu Wangi
                                    </h5>
